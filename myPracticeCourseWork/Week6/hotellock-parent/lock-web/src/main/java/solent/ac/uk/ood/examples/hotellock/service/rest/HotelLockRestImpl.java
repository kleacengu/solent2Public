...
public class HotelLockRestImpl {
    ...
    public Response readCard(@PathParam("roomNumber") String roomNumber, @QueryParam("cardCode") String cardCode) {
        ...
        try {
            ...
            HotelRoomLockServiceImpl hotelRoomLockService = new HotelRoomLockServiceImpl();
            ...
            boolean locked = hotelRoomLockService.unlockDoor(cardCode);
            

            RestMessage restMessage = new RestMessage();
            restMessage.setUnlocked(locked);
